  ...
  describe('dropdown types', () => {
    describe('link', () => {
      it('renders an rs-dropdown-link', () => {
        ...
        expect(ReactDOM.findDOMNode(TestUtils.findRenderedDOMComponentWithTag(dropdownItem, 'a'))).toHaveClass('rs-dropdown-link');
      });
    });
    ...
    describe('category', () => {
      it('renders an rs-dropdown-category', () => {
        ...
        expect(ReactDOM.findDOMNode(TestUtils.findRenderedDOMComponentWithTag(dropdownItem, 'span'))).toHaveClass('rs-dropdown-category');
      });
    });
    ...
    describe('text', () => {
      it('renders an rs-dropdown-text', () => {
        ...
        expect(ReactDOM.findDOMNode(TestUtils.findRenderedDOMComponentWithTag(dropdownItem, 'span'))).toHaveClass('rs-dropdown-text');
      });
    });
  });
